    ...
    <div className="glass-card rounded-lg p-stack-md relative overflow-hidden group hover:border-primary/50 transition-colors duration-300">
      ...
      <div className="flex flex-col md:flex-row gap-8 relative z-10">
        ...
        <div className="flex-1 flex flex-col">
          ...
          <div className="relative w-full h-64 bg-zinc-950 border border-border/50 rounded flex items-center justify-center overflow-hidden">
        ...
        <div className="w-full md:w-64 flex flex-col gap-4">
          <div>
            ...
            <div className="bg-muted/30 border border-border p-3 rounded font-code-sm text-code-sm space-y-1 h-32 overflow-y-auto">
