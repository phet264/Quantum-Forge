  ...
  return (
    <header className="bg-background/80 sticky top-0 z-40 border-b border-border backdrop-blur-md flex justify-between items-center h-16 px-margin-desktop w-full">
      <div className="flex items-center flex-1">
        {/* Mobile Menu Toggle */}
        <button className="md:hidden text-muted-foreground mr-4 p-2 hover:text-primary transition-colors">
      ...
      <div className="flex items-center gap-6">
        ...
        <button className="text-muted-foreground hover:text-primary transition-colors relative active:scale-95">
